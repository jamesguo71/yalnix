...
K_SRCS = kernel.c frame.c load_program.c proc_list.c pl.c pte.c syscall.c trap.c
K_INCS = kernel.h frame.h load_program.h proc_list.h pl.h pte.h syscall.h trap.h
